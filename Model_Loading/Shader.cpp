...
void Shader::set_uniform_3fv(const string& name, glm::vec3 v) {
	glUniform3fv(glGetUniformLocation(id, name.c_str()),1,glm::value_ptr(v));
}

void Shader::set_uniform_4fv(const string& name, glm::vec4 v) {
...
void Shader::set_texture(const string& name, unsigned int GL_TextureNo) {
	glUniform1i(glGetUniformLocation(id,name.c_str()), GL_TextureNo);
}
